...
\NormalTok{## }
\NormalTok{## data:  lip_cancer$Observed  }
\NormalTok{## weights: listw  }
\NormalTok{## }
\NormalTok{## Moran I statistic standard deviate = 4.5416, p-value = 2.792e-06}
\NormalTok{## alternative hypothesis: greater}
\NormalTok{## sample estimates:}
\NormalTok{## Moran I statistic       Expectation          Variance }
\NormalTok{##       0.311975396      -0.018181818       0.005284831}
...
\NormalTok{##  Moran I test under randomisation}
\NormalTok{## }
\NormalTok{## data:  lip_cancer$Observed/lip_cancer$Expected  }
\NormalTok{## weights: listw  }
\NormalTok{## }
\NormalTok{## Moran I statistic standard deviate = 8.2916, p-value < 2.2e-16}
\NormalTok{## alternative hypothesis: greater}
\NormalTok{## sample estimates:}
\NormalTok{## Moran I statistic       Expectation          Variance }
\NormalTok{##       0.589795225      -0.018181818       0.005376506}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{##  Moran I test under randomisation}
\NormalTok{## }
\NormalTok{## data:  lip_cancer$glm_resid  }
\NormalTok{## weights: listw  }
\NormalTok{## }
\NormalTok{## Moran I statistic standard deviate = 4.8186, p-value = 7.228e-07}
\NormalTok{## alternative hypothesis: greater}
\NormalTok{## sample estimates:}
\NormalTok{## Moran I statistic       Expectation          Variance }
\NormalTok{##       0.333403223      -0.018181818       0.005323717}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{##  Moran I test under randomisation}
\NormalTok{## }
\NormalTok{## data:  lip_cancer$car_resid  }
\NormalTok{## weights: listw  }
\NormalTok{## }
\NormalTok{## Moran I statistic standard deviate = 1.0633, p-value = 0.1438}
\NormalTok{## alternative hypothesis: greater}
\NormalTok{## sample estimates:}
\NormalTok{## Moran I statistic       Expectation          Variance }
\NormalTok{##       0.061804482      -0.018181818       0.005658742}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{##  Moran I test under randomisation}
\NormalTok{## }
\NormalTok{## data:  lip_cancer$iar_resid  }
\NormalTok{## weights: listw  }
\NormalTok{## }
\NormalTok{## Moran I statistic standard deviate = 2.6377, p-value = 0.004174}
\NormalTok{## alternative hypothesis: greater}
\NormalTok{## sample estimates:}
\NormalTok{## Moran I statistic       Expectation          Variance }
\NormalTok{##       0.175216401      -0.018181818       0.005375965}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics[width=\textwidth]{Lec19_files/figure-beamer/unnamed-chunk-25-1} \end{center}
...
\NormalTok{##  Moran I test under randomisation}
\NormalTok{## }
\NormalTok{## data:  lip_cancer$iar2_resid  }
\NormalTok{## weights: listw  }
\NormalTok{## }
\NormalTok{## Moran I statistic standard deviate = 0.39186, p-value = 0.3476}
\NormalTok{## alternative hypothesis: greater}
\NormalTok{## sample estimates:}
\NormalTok{## Moran I statistic       Expectation          Variance }
\NormalTok{##       0.011188088      -0.018181818       0.005617437}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics[width=\textwidth]{Lec19_files/figure-beamer/unnamed-chunk-34-1} \end{center}
...
\NormalTok{## Report interval Metrop. Acceptance rate: 32.56%}
\NormalTok{## Overall Metrop. Acceptance rate: 32.56%}
\NormalTok{## -------------------------------------------------}
\NormalTok{## Sampled: 20000 of 20000, 100.00%}
\NormalTok{## Report interval Metrop. Acceptance rate: 32.82%}
\NormalTok{## Overall Metrop. Acceptance rate: 32.69%}
\NormalTok{## -------------------------------------------------}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{m}\OperatorTok{$}\NormalTok{p.theta.recover.samples }\OperatorTok{%>%}
\StringTok{  }\NormalTok{tidybayes}\OperatorTok{::}\KeywordTok{gather_samples}\NormalTok{(sigma.sq, tau.sq, phi) }\OperatorTok{%>%}
...
\begin{center}\includegraphics[width=\textwidth]{Lec19_files/figure-beamer/unnamed-chunk-40-1} \end{center}
